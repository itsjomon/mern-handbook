...
- **Qs 1.** <br> <img src="./assets/qs1.png" alt="Qs 1" hight="150px" width="400px">
- **Qs 2.** <br> <img src="./assets/qs2.png" alt="Qs 2" hight="150px" width="400px">
- **Qs 3.** Use the correct HTML tag to add a paragraph with the text "Hello World!".

- **Qs 4.** Mark up the text with appropriate tags:
...
- **Qs 7.** Read the following topics on MDN:
  - Hr Tag in HTML https://developer.mozilla.org/en-US/docs/Web/HTML/Element/hr
